...
free(void *ap)
{
 ...
 678:	1ac7b783          	ld	a5,428(a5) # 820 <freep>
 ...
 6a6:	00e6ea63          	bltu	a3,a4,6ba <free+0x50>
{
 ...
 6e8:	12f73e23          	sd	a5,316(a4) # 820 <freep>
}
 6ec:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 71a:	10a53503          	ld	a0,266(a0) # 820 <freep>
 ...
 742:	0e290913          	addi	s2,s2,226 # 820 <freep>
  if(p == (char*)-1)
 746:	5afd                	li	s5,-1
 748:	a88d                	j	7ba <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 74a:	00000797          	auipc	a5,0x0
 74e:	0de78793          	addi	a5,a5,222 # 828 <base>
 752:	00000717          	auipc	a4,0x0
 756:	0cf73723          	sd	a5,206(a4) # 820 <freep>
 75a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 77c:	0aa73423          	sd	a0,168(a4) # 820 <freep>
      return (void*)(p + 1);
